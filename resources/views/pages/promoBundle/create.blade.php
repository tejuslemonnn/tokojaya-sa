                        ...
                        <div class="row">
                            ...
                            <div class="col-lg fv-row">
                                <input type="text" name="nama_bundel"
                                    ...
                                    value="{{ old('nama_bundel') }}" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg fv-row">
                                <input type="date" name="mulai_berlaku"
                                    ...
                                    value="{{ old('mulai_berlaku') }}" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg fv-row">
                                <input type="date" name="selesai_berlaku"
                                    ...
                                    placeholder="Selesai Berlaku" value="{{ old('selesai_berlaku') }}" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg fv-row">
                                <input type="number" min="0" name="harga_promo"
                                    ...
                                    value="{{ old('harga_promo') }}" required />
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="number" name="qty[]" class="form-control qty"
                                                            readonly value="{{ old('qty.' . $index) }}" min=0>
                                                    <td><input type="number" name="harga[]"
                                                            class="form-control harga" min="0" readonly></td>
                                                    </td>
                                                    <td>
